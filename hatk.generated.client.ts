...
export type { Event, CreateReport, DescribeCollections, DescribeFeeds, DescribeLabels, GetFeed, GetRecord, GetRecords, SearchRecords, UploadBlob, RecordRegistry, CreateRecord, DeleteRecord, PutRecord, Uri, RepoRef, LabelDefinition, LabelLocale } from './hatk.generated.ts'
